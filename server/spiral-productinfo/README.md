...
### GRPC
1. Configuration file: app/config/grpc.php
2. Use php app.php grpc:generate console command to generate gRPC stubs
3. Documentation: https://spiral.dev/docs/grpc-configuration
### RoadRunnerBridge
